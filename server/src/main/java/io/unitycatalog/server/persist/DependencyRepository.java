...
public class DependencyRepository {
  ...
  public void createDependencies(
      Session session, UUID dependentId, String dependentType, List<DependencyDAO> dependencies) {
  ...
  public List<DependencyDAO> getDependencies(
      Session session, UUID dependentId, String dependentType) {
    String hql =
  ...
  public void deleteDependencies(Session session, UUID dependentId, String dependentType) {
    String hql =
